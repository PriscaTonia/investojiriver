...
const opportunities = [
  {
    ...
    icon: Sprout,
    description: "Expansion of rice mills and cashew processing hubs. Leveraging the fertile basin of Oji River for industrial scale production.",
    status: "Now Open",
  },
  {
    title: "Manufacturing & Industry",
    icon: Factory,
    description: "Creation of a light-industrial manufacturing cluster. Focus on component assembly and local material engineering.",
    status: "Coming Soon",
  },
  {
    title: "Real Estate & Infrastructure",
    icon: Building2,
    description: "Premium residential estates and modern commercial office spaces to support the growing white-collar demographic.",
    status: "Now Open",
  },
];
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mb-16">
          ...
          >
            <h2 className="text-4xl md:text-5xl text-brand-green font-serif mb-8 leading-tight">
              Investment Opportunities <br />in Oji River
            </h2>
            <p className="text-lg text-brand-green/70 leading-relaxed max-w-2xl">
              Oji River is undergoing a transformational decade of growth. ORIPA is actively identifying and structuring investment opportunities across key sectors — and inviting serious investors to get in early.
            </p>
          </motion.div>
        </div>
            ...
            >
              <div className="flex justify-between items-start mb-8">
                ...
                <span className={`text-[10px] uppercase tracking-widest font-bold px-3 py-1 ${
                  opp.status === "Now Open" ? "bg-brand-green text-brand-gold" : "bg-brand-gold/20 text-brand-green"
                }`}>
                  {opp.status}
                </span>
              </div>
              <h3 className="text-xl font-serif text-brand-green mb-4 group-hover:text-brand-gold transition-colors">{opp.title}</h3>
              <p className="text-brand-green/60 text-sm leading-relaxed mb-6">{opp.description}</p>
            </motion.div>
          ))}
        </div>
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-3xl md:text-4xl text-brand-white font-serif mb-4">Ready to invest in Oji River's future?</h3>
            <p className="text-brand-white/60 mb-10 max-w-xl mx-auto">Join a growing network of investors building the next decade of Oji River.</p>
